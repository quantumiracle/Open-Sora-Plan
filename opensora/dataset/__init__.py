...
# avoid using lambda for serialization
ae_norm = {
    'CausalVAEModel_4x8x8': normalize_2x_minus_1,
    'CausalVQVAEModel_4x4x4': normalize_minus_0_5,
    'CausalVQVAEModel_4x8x8': normalize_minus_0_5,
    'VQVAEModel_4x4x4': normalize_minus_0_5,
    'VQVAEModel_4x8x8': normalize_minus_0_5,
    "bair_stride4x2x2": normalize_minus_0_5,
    "ucf101_stride4x4x4": normalize_minus_0_5,
    "kinetics_stride4x4x4": normalize_minus_0_5,
    "kinetics_stride2x4x4": normalize_minus_0_5,
    'stabilityai/sd-vae-ft-mse': transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], inplace=True),
    'stabilityai/sd-vae-ft-ema': transforms.Normalize(mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], inplace=True),
    'vqgan_imagenet_f16_1024': normalize_2x_minus_1,
    'vqgan_imagenet_f16_16384': normalize_2x_minus_1,
    'vqgan_gumbel_f8': normalize_2x_minus_1,
}
